...
Calculates Robbins Constant to an arbitrary precision of [N] significant digits using a highly optimized 12-core parallelized algorithm.
...
Usage:
    python "Robbins Constant.py" -n 1000
